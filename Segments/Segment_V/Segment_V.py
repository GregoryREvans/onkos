...
directory = '/Users/evansdsg2/Scores/onkos/Segments/Segment_V'
pdf_path = f'{directory}/Segment_V.pdf'
path = pathlib.Path('Segment_V.pdf')
if path.exists():
...
score_lines = open('/Users/evansdsg2/Scores/onkos/Segments/Segment_V/Segment_V.ly').readlines()
open('/Users/evansdsg2/Scores/onkos/Build/Score/Segment_V.ly', 'w').writelines(score_lines[15:-1])
