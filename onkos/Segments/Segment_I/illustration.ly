...
\include "/Users/evansdsg2/evans/evans/lilypond/evans-markups.ily"   %! abjad.LilyPondFile._get_formatted_includes()
            ...
            \context Staff = "Staff 1"
            {
                \context Voice = "Voice 1"
                {
                    ...
                    }
                    {
                        ...
                        \tweak text #tuplet-number::calc-fraction-text
                        \tweak TupletNumber.text #(tuplet-number::append-note-wrapper(tuplet-number::non-default-tuplet-fraction-text 17 9) "8")
                        \times 9/17 {
                            \tweak TupletNumber.text #(tuplet-number::append-note-wrapper(tuplet-number::non-default-tuplet-fraction-text 3 2) "8.")
                            \times 2/3 {
