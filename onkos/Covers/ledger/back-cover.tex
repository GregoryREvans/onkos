...
\pmb{Violin Concerto}
\switchcolumn[1]
\pmb{Five Excuses} (for string trio)
\switchcolumn[1]
\pmb{Adumbration} "String Trio 2"
\switchcolumn[1]
\pmb{Hamon sh\=u} "String Quartet 1"
\switchcolumn[1]
\pmb{Cthar} (for two cellos)
\switchcolumn[1]
\pmb{Four Ages of Sand} (fl, alt sx, vc)
\switchcolumn[2]
\pmb{Bewegt die Erde}:
\switchcolumn[2]
...
\switchcolumn[2]
\pmb{Bar Do} (for bassoon)
\switchcolumn[3]
\pmb{Arquitectura 11611}
\switchcolumn[3]
\pmb{Metamorphoses} (after Illouz)
\switchcolumn[3]
\pmb{GUERRERO} (21 saxophones)
\switchcolumn[3]
\pmb{Tiansh\=u} (12 players)
