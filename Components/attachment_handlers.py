...
#######
articulation_handler_five = ArticulationHandler(
...
notehead_handler_five = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )
...
#######
articulation_handler_six = ArticulationHandler(
...
glissando_handler_six = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='dotted-line',
    )

notehead_handler_six = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )
...
articulation_handler_seven = ArticulationHandler(
    articulation_list=['tremolo', 'tremolo', 'portato', 'espressivo', ],
    continuous=True,
    )
...
dynamic_handler_seven = DynamicHandler(
    starting_dynamic='f',
    hairpin='>',
    ending_dynamic='p',
    continuous=True,
...
glissando_handler_seven = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='solid-line',
    )

notehead_handler_seven = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_seven = PitchHandler(
    pitch_list=analyzed_list_3,
    continuous=True,
    )

text_span_handler_seven = TextSpanHandler(
    span_two_positions=['st.', 'ord.', 'sp.', 'msp.', 'ord.',],
    span_two_style='dashed-line',
    span_two_padding=12,
    attach_span_two_to='bounds',
...
#######
articulation_handler_eight = ArticulationHandler(
    articulation_list=['tenuto', 'staccato', 'portato', ],
    continuous=True,
    )
...
dynamic_handler_eight = DynamicHandler(
    starting_dynamic='ppp',
    hairpin='<',
    ending_dynamic='p',
    continuous=True,
...
notehead_handler_eight = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_eight = PitchHandler(
    pitch_list=perm_list,
    continuous=True,
    )

text_span_handler_eight = TextSpanHandler(
    span_one_positions=['8/8', '7/8', '6/8', '5/8', '4/8', '3/8', '2/8', '1/8', ],
    span_one_style='solid-line',
    span_one_padding=9,
    attach_span_one_to='leaves',
...
#######
articulation_handler_nine = ArticulationHandler(
    articulation_list=['tenuto', 'tremolo', 'tremolo', 'espressivo', 'tremolo',],
    continuous=True,
    )
...
dynamic_handler_nine = DynamicHandler(
    starting_dynamic='mp',
    hairpin='>',
    ending_dynamic='niente',
    continuous=True,
...
glissando_handler_nine = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='dotted-line',
    )

notehead_handler_nine = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_nine = PitchHandler(
    pitch_list=random_walk_list,
    continuous=True,
    )

text_span_handler_nine = TextSpanHandler(
    span_one_positions=['8/8', '7/8', '6/8', '5/8', '4/8', '3/8', '2/8', '1/8', ],
    span_one_style='solid-line',
    span_one_padding=9,
    attach_span_one_to='leaves',
...
articulation_handler_ten = ArticulationHandler(
    articulation_list=['tremolo', 'tremolo', 'portato', 'espressivo', ],
    continuous=True,
    )
...
dynamic_handler_ten = DynamicHandler(
    starting_dynamic='f',
    hairpin='>',
    ending_dynamic='p',
    continuous=True,
...
glissando_handler_ten = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='solid-line',
    )

notehead_handler_ten = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_ten = PitchHandler(
    pitch_list=analyzed_list_4,
    continuous=True,
    )

text_span_handler_ten = TextSpanHandler(
    span_two_positions=['st.', 'ord.', 'sp.', 'msp.', 'ord.',],
    span_two_style='dashed-line',
    span_two_padding=12,
    attach_span_two_to='bounds',
...
#######
articulation_handler_eleven = ArticulationHandler(
    articulation_list=['tenuto', 'staccato', 'portato', ],
    continuous=True,
    )
...
dynamic_handler_eleven = DynamicHandler(
    starting_dynamic='ppp',
    hairpin='<',
    ending_dynamic='p',
    continuous=True,
...
notehead_handler_eleven = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_eleven = PitchHandler(
    pitch_list=perm_list,
    continuous=True,
    )

text_span_handler_eleven = TextSpanHandler(
    span_one_positions=['8/8', '7/8', '6/8', '5/8', '4/8', '3/8', '2/8', '1/8', ],
    span_one_style='solid-line',
    span_one_padding=9,
    attach_span_one_to='leaves',
...
#######
articulation_handler_twelve = ArticulationHandler(
    articulation_list=['tenuto', 'tremolo', 'tremolo', 'espressivo', 'tremolo',],
    continuous=True,
    )
...
dynamic_handler_twelve = DynamicHandler(
    starting_dynamic='mp',
    hairpin='>',
    ending_dynamic='niente',
    continuous=True,
...
glissando_handler_twelve = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='dotted-line',
    )

notehead_handler_twelve = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_twelve = PitchHandler(
    pitch_list=random_walk_list,
    continuous=True,
    )

text_span_handler_twelve = TextSpanHandler(
    span_one_positions=['8/8', '7/8', '6/8', '5/8', '4/8', '3/8', '2/8', '1/8', ],
    span_one_style='solid-line',
    span_one_padding=9,
    attach_span_one_to='leaves',
...
articulation_handler_thirteen = ArticulationHandler(
    articulation_list=['tremolo', 'tremolo', 'portato', 'espressivo', ],
    continuous=True,
    )
...
dynamic_handler_thirteen = DynamicHandler(
    starting_dynamic='f',
    hairpin='>',
    ending_dynamic='p',
    continuous=True,
...
glissando_handler_thirteen = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='solid-line',
    )

notehead_handler_thirteen = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_thirteen = PitchHandler(
    pitch_list=analyzed_list_5,
    continuous=True,
    )

text_span_handler_thirteen = TextSpanHandler(
    span_two_positions=['st.', 'ord.', 'sp.', 'msp.', 'ord.',],
    span_two_style='dashed-line',
    span_two_padding=12,
    attach_span_two_to='bounds',
...
#######
articulation_handler_fourteen = ArticulationHandler(
    articulation_list=['tenuto', 'staccato', 'portato', ],
    continuous=True,
    )
...
dynamic_handler_fourteen = DynamicHandler(
    starting_dynamic='ppp',
    hairpin='<',
    ending_dynamic='p',
    continuous=True,
...
notehead_handler_fourteen = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_fourteen = PitchHandler(
    pitch_list=perm_list,
    continuous=True,
    )

text_span_handler_fourteen = TextSpanHandler(
    span_one_positions=['8/8', '7/8', '6/8', '5/8', '4/8', '3/8', '2/8', '1/8', ],
    span_one_style='solid-line',
    span_one_padding=9,
    attach_span_one_to='leaves',
...
#######
articulation_handler_fifteen = ArticulationHandler(
    articulation_list=['tenuto', 'tremolo', 'tremolo', 'espressivo', 'tremolo',],
    continuous=True,
    )
...
dynamic_handler_fifteen = DynamicHandler(
    starting_dynamic='mp',
    hairpin='>',
    ending_dynamic='niente',
    continuous=True,
...
glissando_handler_fifteen = GlissandoHandler(
    # glissando_style='hide_middle_note_heads',
    line_style='dotted-line',
    )

notehead_handler_fifteen = NoteheadHandler(
    notehead_list=['cross', 'harmonic-mixed', 'diamond', 'triangle', 'slash', 'default',  ],
    continuous=True,
    )

pitch_handler_fifteen = PitchHandler(
    pitch_list=random_walk_list,
    continuous=True,
    )

text_span_handler_fifteen = TextSpanHandler(
    span_one_positions=['8/8', '7/8', '6/8', '5/8', '4/8', '3/8', '2/8', '1/8', ],
    span_one_style='solid-line',
    span_one_padding=9,
    attach_span_one_to='leaves',
